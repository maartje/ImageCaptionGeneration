...
python3 -W ignore report.py --config "$HOME"/ImageCaptionGeneration/configs/config_maartje.json --model_dir show_tell_adam_min5 &

python3 -W ignore report.py --config "$HOME"/ImageCaptionGeneration/configs/config_maartje.json --model_dir show_tell_adam_min4 &

python3 -W ignore report.py --config "$HOME"/ImageCaptionGeneration/configs/config_maartje.json --model_dir show_tell_adam_min3 &
